 ...
 *   <a href="http://www.domain.com/create_review/{$prod.prod_id}/{$prod.cat_id}">{$prod.name}</a>
 ********************************************************************}
...
<table width="600">
  {foreach from=$products item=prod}
    ...
    <td width="250"><a href="http://www.commercev3.com/create_review/{$prod.prod_id}/{$prod.cat_id}">Submit a Review</a></td>
  </tr>
  {/foreach}
</table
>
