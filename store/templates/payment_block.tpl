   ...
   <div id="cc_panel" style="display:{if $meth == 'creditcard' or $meth == 'purchasecard' or ($valid.return and $valid.payment_method == 'purchasecard') or ($valid.return and $valid.payment_method == 'creditcard')}block{else}none{/if};">
    ...
    <div class="col-sm-6">
      <div class="form-group {if $valid.return and $valid.is_valid.ccnum == 'n'} has-error has-feedback bg-danger{/if}">
       ...
       <input class="form-control" type="number" id="ccnum" name="ccnum"{if $view == 'checkout_shippingaddress'} size="30"{/if} maxlength="50" />{if $valid.return and $valid.is_valid.ccnum == 'n'}<span class="glyphicon glyphicon-remove form-control-feedback"></span>{/if}
      </div>
    </div>
    {if $settings.display_cvv2 == 'y'}
      <div class="col-sm-6">
       <div class="form-group {if $valid.return && !$valid.cvv2 && $valid.payment_method == 'creditcard' && $valid.cctype != 'PL'} has-error has-feedback bg-danger{/if}">
        ...
        <input class="form-control" type="number" id="cvv2" name="cvv2" size="4" maxlength="4" />{if $valid.return && !$valid.cvv2 && $valid.payment_method == 'creditcard' && $valid.cctype != 'PL'}<span class="glyphicon glyphicon-remove form-control-feedback"></span>{/if}
   ...
   <div id="gc_panel" style="display:{if $meth == 'giftcertificate' or ($valid.return and $valid.payment_method == 'giftcertificate')}block{else}none{/if};">
    <div class="col-sm-6">
      <div class="form-group {if $valid.return and $valid.is_valid.gift_certificate == 'n'} has-error has-feedback bg-danger{/if}">
       ...
       <input class="form-control" type="text" id="gift_certificate" name="gift_certificate" value="{$valid.gift_certificate}"{if $view == 'checkout_shippingaddress'} size="30"{/if} maxlength="50" />
    {if $settings.gcv_processor == 'y' && $settings.gcv_version == 'current'}
     ...
     {/if}
{if $valid.return and $valid.is_valid.gift_certificate == 'n'}<span class="glyphicon glyphicon-remove form-control-feedback"></span>{/if}
      </div>
    </div>
