...
<div class="row">
  ...
  <div class="col-sm-6">
    <div class="form-group {if $valid.return and $valid.gift_message.$num[$smarty.section.gm_line.index] == 'n'} error{/if}">
      ...
      <input class="form-control" type="text" id="gift_message{$num}_line{$smarty.section.gm_line.index}" name="gift_message{$num}_line{$smarty.section.gm_line.index}" value="{$valid.gift_message.$num[$smarty.section.gm_line.index]}" maxlength="{$settings.gift_msg_num_chars}" />
    </div>
  </div>
{else}
  <div class="col-sm-6">
...
{else}
  <div class="col-sm-6">
    <div class="form-group">
      ...
      <input class="form-control" type="text" id="gift_message{$num}" name="gift_message{$num}" value="{$valid.gift_message.$num}" maxlength="100" />
    </div>
  </div>
{/if}
...
{*<div class="form-group {if $valid.return and !$valid.email} has-error has-feedback bg-danger{/if}">
  ...
  <div class="col-sm-6">  
    <div class="form-group">
      ...
      <textarea class="form-control" id="shipping_comments" name="s_comments" rows="5" cols="{if $num > 1}30{else}18{/if}">{$valid.s_comments}</textarea>
    </div>
  </div>
</div>
</fieldset>
