...
<form method="post" class="form-inline" action="index.php" name="newsletter">
  ...
  <div class="form-group">
      ...
      <input type="email" class="form-control" name="add_email" value="" placeholder="Sign Up for E-Newsletter" />{if $newsletter_error != ''} <font color="#ff0000"><b>X</b></font> {/if}
  </div>
  ...
  *}
  ...
  <input type="submit" name="submit" value="Submit" class="btn btn-white btn-sm" />
</form>
</div>