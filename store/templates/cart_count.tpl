...
<section id="cartitems">
  <a href="/viewcart">{*<span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>*}<img src="{$img_prefix}/images/cart.png" alt="cart"> Cart</a>
  {*
  {$currency_type}<span class='minicart_total_price'>{$total_price|commify}</span>
  <a id="vcart" href="/viewcart">View cart</a>
  <!-- <span class='minicart_total_qty'>{$total_qty}</span> Items -->
  *}
</section>