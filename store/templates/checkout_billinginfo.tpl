...
{/if}
  ...
  <tr>
    ...
    <td style="padding-top:15px;">
      <input type="submit" name="submit_edit" value="Edit" class="button medium style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <input type="submit" name="submit_continue" value="Submit Order" tabindex="1" class="button medium style1" id="continue_btn"{if $settings.amazon_checkout == 'y' && isset($smarty.session.amazon_id)} disabled{/if} />
    </td>
  </tr>
