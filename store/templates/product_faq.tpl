...
<h1>Rishi Tea's Online Tea FAQs</h1>
  <div id='content'>
    <div class="faqs">
    <div class="ques-section">
      <div class="hdr">Freshness</div>
      <p class="ques"><strong>How should I store my tea?</strong></p>
      <div class="ans">Tea does not necessarily “go bad” or spoil, but it does lose its freshness gradually over time. You can mitigate this effect by storing tea inside an airtight container in a dry, cool, and dark cupboard or pantry. Tea is hygroscopic—meaning it absorbs moisture and nearby aromas—so it is best to stash your teas away from other highly fragrant products like coffee, spices, or herbs. For optimal freshness, keep your tea leaves inside our resealable foil bags. Gently squeeze excess air out of the bag each time you re-seal it, and place the bag in a canister or jar to protect it from the elements. In general, you can preserve the freshness of your tea by minimizing exposure to heat, light, air and moisture. <br /><br />
      </div>
    </div>
    <div class="ques-section">
      <p class="ques"><strong>How long does tea stay fresh?</strong></p>
      <div class="ans">Tea is like the dry herbs or spices in your kitchen–it does not really “go bad” but the complexity of its aroma will fade over time. Of all tea types, green and white teas will lose their freshness most quickly. To experience peak freshness, we recommend consuming these teas within 2 months from the time you first open the package. Matcha green tea powder should be enjoyed within 2 weeks, because the powder will undergo “post-oxidation” when exposed to air, transforming its bright green color into a stale shade of pea-green or even yellow. We recommend enjoying most oolong, black, and herbal teas within 4 months for the best flavor. Roasted oolong and Pu-erh teas have the unique ability to ripen and develop complexity with age, if stored properly, for several years.<br />
      </div>
    </div>
    <div class="ques-section">
      <p class="ques"><strong>How many servings do I get out of a bag of loose leaf tea?</strong></p>
      <div class="ans"> This depends on the size of the bag and the amount of tea you use for each serving. In general, we recommend that most Rishi Teas be measured at 1 tablespoon (4-5g) per 8 oz of water. A 250g bag yields about 50 – 60 servings, whereas a one pound bag (454g) would yield about 90 – 120 servings. One of the joys of loose leaf tea is that you can re-infuse the tea leaves several times during each brewing session. Check the label and product description online for specific brewing tips for each tea.<br />
      </div>
    </div>
    <div class="ques-section">
        <div class="hdr">Sourcing</div>
        <p class="ques"><strong>What is direct trade tea?</strong></p>
        <div class="ans"> Direct trade is not a formal certification, but a sourcing philosophy and a commitment to a way of doing business. Direct trade procurement models are becoming the standard in specialty tea, coffee, and chocolate markets.
        <br /><br />
    ...
    <div class="ques-section">
      <p class="ques"><strong>Are your teas free of GMOs (genetically modified organisms)? </strong></p>
      <div class="ans">All Rishi teas are free of GMOs. Fortunately, GMOs are not as significant an issue in the tea industry as they are in grain or produce markets. The tea plant, Camellia sinensis, is grown without genetic modification. Instead, hundreds of tea plant strains known as cultivars (“cultivated varieties”) are bred and planted through traditional botanical methods like crossing. GMOs are explicitly forbidden under the USDA’s organic program, so any Rishi tea bearing the USDA Organic logo is free of GMOs.<br /><br />
      </div>
    </div>
    <div class="ques-section">
      <p class="ques"><strong>What are ‘natural flavors’?</strong></p>
      <div class="ans">Natural flavors are concentrated liquid extracts made from real food ingredients. We use natural flavors to complement dried fruits, herbs, and other botanicals in some blends to create a complex depth of flavor that infuses deeply into the tea leaves. We use our natural flavors in compliance with USDA NOP organic standards and we are one of few tea companies who do not use any artificial flavors in our teas. <br /><br />
      </div>
    </div>
    <div class="ques-section">
      <p class="ques"><strong>Are your teas gluten/dairy/allergen free?</strong></p>
      <div class="ans">All Rishi Tea products are free from ingredients containing gluten or dairy. Additionally, we do not work with ingredients containing or exposed to eggs, wheat, corn, soy, shellfish or peanuts. We do use coconut and ramon nut in several blends, but follow a strict allergen control procedure to separate these ingredients from our allergen-free ingredients.  <br /><br />
      </div>
    </div>
    <div class="ques-section">
      <p class="ques"><strong>What are your tea bags made of? Are they BPA free?</strong></p>
    ...
    <div class="ques-section">
      <p class="ques"><strong>Are you testing your Japanese teas for radiation?</strong></p>
      <div class="ans">On March 11, 2011 the Tohoku tsunami and earthquake off of the northeast coast of Japan caused the devastating Fukushima Daiichi nuclear power plant accident, releasing radioactivity into the environment. 
     	<br /><br />
    ...
    Our test results continually confirm that Rishi’s Japanese teas are completely safe. Our latest test results are as follows:
        ...
        <table width="100%" border="0" cellpadding="5">
          <tbody>
            <tr>
              <td valign="bottom" style="padding:0 5px 5px 0;vertical-align:bottom !important" width="20%"><strong>Isotope</strong></td>
              <td valign="bottom" style="padding:0 5px 5px 5px;vertical-align:bottom !important" width="20%"><strong>Unit</strong></td>
              <td valign="bottom" style="padding:0 5px 5px 5px;vertical-align:bottom !important" width="20%"><strong>Result</strong></td>
              <td valign="bottom" style="padding:0 0 5px 5px;vertical-align:bottom !important" width="40%"><strong>US FDA Maximum Allowable Limits for Tea</strong></td>
            </tr>
            <tr>
              <td style="padding:0 3px">Cesium-134</td>
              <td style="padding:0 3px">Bq/kg</td>
              <td style="padding:0 3px">Non-detect</td>
              <td style="padding:0 3px">1,200</td>
            </tr>
            <tr>
              <td style="padding:0 3px">Cesium-137</td>
              <td style="padding:0 3px">Bq/kg</td>
              <td style="padding:0 3px">Non-detect</td>
              <td style="padding:0 3px">1,200</td>
            </tr>
            <tr>
              <td style="padding:0 3px">Iodine-131</td>
              <td style="padding:0 3px">Bq/kg</td>
              <td style="padding:0 3px">Non-detect</td>
              <td style="padding:0 3px">170</td>
            </tr>
          </tbody>
        </table>
    <br /><br />
    ...
    <div class="ques-section">
      <p class="ques"><strong>What are antioxidants and why are they talked about so much in tea?</strong></p>
      <div class="ans">Antioxidants are molecules that may prevent, or even reverse, certain types of cellular damage in the body by neutralizing other oxidative molecules. All tea from the Camellia sinensis plant contains antioxidants in the form of tea polyphenols, including epigallocatechin gallate (EGCG), epigallocatechin (EGC), and others. Polyphenols are found in a wide variety of plant foods, including tea, red wine, dark chocolate, olive oil, and berries. Researchers believe polyphenols may help mitigate age-related or degenerative conditions. However, this has not been proven conclusively, so the FDA does not permit food companies to make specific claims about tea and disease prevention. This is why we suggest tea drinkers interested in the health benefits of tea simply enjoy a variety of tea types. <br /><br />
      </div>
    </div>
    <div class="ques-section">
      <p class="ques"><strong>If I brew my tea longer, will I get more health benefits?</strong></p>
      <div class="ans">Not necessarily. The most water-soluble, easily extracted components in tea are the beneficial polyphenols (antioxidants). By contrast, one of the least water-soluble components in tea is caffeine. Brewing tea for longer periods of time will simply result in an overly-strong, bitter cup. <br /><br />
      </div>
    </div>
    <div class="ques-section">
    <div class="hdr">Caffeine</div>
      <p class="ques"><strong>How much caffeine is in tea, compared to coffee?</strong></p>
      <div class="ans">Caffeine is one of three stimulating alkaloids found in tea. The others are theobromine and theophylline. Theobromine is a mild stimulant also found in greater concentration in chocolate. 
   		 <br /><br />
    ...
    <div class="ques-section">
      <p class="ques"><strong>What do the caffeine levels represent on your tea bag and loose leaf packaging?</strong></p>
      <div class="ans">We worked with an independent lab to measure the caffeine content of our packaged teas. The teas were brewed according to our recommended brewing instructions for temperature and infusion time, and then the caffeine content of the infusion was measured. We found that most teas registered neatly within three tiers:
        <br /><br />
        <strong>LOW:</strong> < 20 mg / 8oz cup<br />
        <strong>MEDIUM: </strong>20 – 40 mg / 8oz cup<br />
        <strong>HIGH: > </strong>40 mg / 8oz cup<br />
        <br /><br />
    ...
    <div class="ques-section">
      <p class="ques"><strong>How does caffeine content vary between types of tea?</strong></p>
      <div class="ans">The six tea types are differentiated by their processing steps. The techniques used to process fresh tea leaves—such as rolling, firing, oxidizing, or drying—do not alter caffeine on a molecular level, and thus they do not affect the amount of caffeine that was originally in the fresh leaf. Teas that undergo baking or roasting in their final stages, such as Houjicha or Iron Goddess, may lose some caffeine by pyrolysis, whereby the caffeine molecule is literally baked out of the tea leaves. But in general, the processing methods do not affect caffeine content, so the various types of tea can have similar levels of caffeine. 
     	<br /><br />
    ...
    <div class="ques-section">
      <p class="ques"><strong>When you re-steep your tea, how much caffeine is in the 2nd and 3rd infusions?</strong></p>
      <div class="ans">A decent amount! After a first 4-5 minute infusion, most teas have only released 30-50% of their total caffeine. The tea leaves will release the remaining caffeine in subsequent infusions. 
    	<br /><br />
    ...
    <div class="ques-section">
      <p class="ques"><strong>Is it true you can rinse the caffeine off your tea by brewing it for 30 seconds and discarding that first cup?</strong></p>
      <div class="ans">No. It takes several minutes to extract significant amounts of caffeine from the leaf. Using higher temperature water and a longer infusion time will yield more caffeine in the cup. By contrast, cooler water and short infusion times do not extract as much caffeine. This is why it was believed for so many years that white tea and green tea (both typically brewed with cooler water for a briefer time) do not contain as much caffeine as black tea (higher temperature, longer infusion time). <br /><br />
      </div>
    </div>
    <div class="ques-section">
      <p class="ques"><strong>Why is the tea high different from the coffee buzz?</strong></p>
      <div class="ans">Tea is known to create a more even, sustained lift compared to the buzz and crash of coffee. There are several reasons for this.
     	<br /><br />
