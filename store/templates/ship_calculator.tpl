  ...
  <div id="cityrow{$label}" style="display: none;">
    <div id="freightcity{$label}" style="{if !isset($settings.fedex_freight_account_num) || $settings.fedex_freight_account_num == ''}display: none;{/if}">
      ...
      <input type="text" id="city{$label}" name="city{$label}" size="15" maxlength="40" />
        ...
        <div class="form-group">
          <label for="method{$label}">Select Method:</label>
      ...
      <div class="col-sm-6">
        ...
        <div class="nopad">
          <div class="col-xs-6">
            <label>{*<span id="tax_label{$label}"></span> *}Tax:</label>
          </div>
          <div class="col-xs-6">
        ...
        <div class="col-xs-12">
          <div class="note nopad">
            <p>Note: {if $settings.product_mapping == 'add_cart'}Promotional discounts and t{else}T{/if}axes may be applied to your order total and/or shipping total based on your shipping and/or billing state.</p>
          </div>
        </div>
