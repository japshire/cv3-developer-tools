{if $also_bought|@count > 0}

<div class="spacer"></div>
<div class="sectionHeader">People who purchased this product also purchased:</div>

<table width="100%" cellpadding="0" cellspacing="5">

{counter start=1 assign=number_ab}
{foreach from=$also_bought item=prod}
{cycle values="left2,middle2,middle3,right2" assign="nwhich"}
{if $nwhich == "left2"}
...
{/if}
{$nbegin}
{if $number_ab <= #also_bought_num_displayed#}
