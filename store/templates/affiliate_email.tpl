 ...
 ********************************************************}
 {if $type == 'approve'}
{$affiliate.name} - <br />You have been accepted into our affiliate program.  Your code is {$affiliate.code} and your commission rate is {if $affiliate.type=='visit'}${$affiliate.commission} per visit{else}{$affiliate.commission}% per order{/if}. Please use http://{$domain}?a={$affiliate.code} to link to our store.
 {elseif $type == 'delete'}
...
{$affiliate.name} - <br />Congratulations, you have joined our Refer-A-Friend program.  Your code is {$affiliate.code} and your commission rate is {if $affiliate.type=='visit'}${$affiliate.commission} per visit{else}{$affiliate.commission}% per order{/if}. Please direct your friends to use http://{$domain}?a={$affiliate.code} to link to our store.
 {elseif $type == 'referafriend_sample'}
Hello, You are invited to visit My Store.  <a href="http://{$domain}?a={$affiliate.code}">Click here</a> to start your shopping experience!
 {elseif $type == 'eparty'}
...
{$affiliate.name} - <br />You have scheduled an E-Party for {$affiliate.eparty_date}.  Your code is {$affiliate.code} and your commission rate is {if $affiliate.type=='visit'}${$affiliate.commission} per visit{else}{$affiliate.commission}% per order{/if}. Please direct your friends to use http://{$domain}?a={$affiliate.code} to link to our store.
 {elseif $type == 'eparty_sample'}
Hello, You are invited to join my E-Party on {$affiliate.eparty_date}.  <a href="http://{$domain}?a={$affiliate.code}">Click here</a> to start your shopping experience!
 {/if}
