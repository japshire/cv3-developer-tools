...
<div class="quick-checkout nopad">
      ...
      *}
      ...
      <div class="col-sm-6">
       <div class="form-group {if $valid.return and $valid.gift_message.$num[$smarty.section.gm_line.index] == 'n'} has-error has-feedback bg-danger{/if}">
        ...
        <input class="form-control" type="text" id="gift_message1_line{$smarty.section.gm_line.index}" name="gift_message1_line{$smarty.section.gm_line.index}" value="{$valid.gift_message.1[$smarty.section.gm_line.index]}" maxlength="{$settings.gift_msg_num_chars}" />{if $valid.return and $valid.gift_message.$num[$smarty.section.gm_line.index] == 'n'}<span class="glyphicon glyphicon-remove form-control-feedback"></span>{/if}
      </div>
    </div>
    {else}
    <div class="col-sm-6">
  ...
  <div class="col-sm-6">
   <div class="form-group">
    ...
    <input class="form-control" type="text" id="gift_message1" name="gift_message1" value="{$valid.gift_message.1}" />
  </div>
</div>
{/if}
...
<div class="col-sm-6">
  <div class="form-group">
    <label for='s_method1'>Shipping Method:</label>
...
<div class="col-sm-6">
  <div class="form-group">
    ...
    <textarea class="form-control" name="s_comments" id="s_comments" cols="17" rows="6">{$valid.s_comments}</textarea>
  </div>
</div>
</div>
</div>
