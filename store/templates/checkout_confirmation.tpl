...
<div class="confirmation">
  ...
  <form method="post" action="index.php"> 
    ...
    <div class="clearfix">
        ...
        <div class="col-sm-4">
          <div id="person_info">
              ...
              <div class="heading mar_btm">
                ...
                <input type="submit" name="submit_billing" value="Edit" class="btn btn-default btn-sm" />
              </div>
              {/if}
              <section>
          ...
          <div id="payment_info">
              <div class="heading mar_btm">
                ...
                {if $settings.paypal_express_checkout != 'y'}
                    <input type="submit" name="submit_payment" value="Edit" class="btn btn-default btn-sm" />
                  {/if}
              </div>
              <section>
        ...
        <div class="col-sm-4">
          <div id="total_info">
                  ...
                  <section class="totals">
                    ...
                    <div class="row">
                      <div class="col-xs-5 col-sm-6"><label>Tax Total:</label></div> 
      ...
      <div class=" mar_btm">
        <h3>Order &amp; Shipping Information{if $options.$num != 'One'}: Recipient {$options.$num}{/if}
        </h3>
        {if $settings.paypal_express_checkout != 'y'}
          <input type="submit" name="submit_shipping" value="Edit" class="btn btn-default btn-sm" />
        {/if}
      </div>
                ...
                <div class="row mar_btm pdd_tp10 border_top">
                  <div class="col-sm-4">
                    <div class="row">
                      ...
                      {/if}
                      {if $prod.recurring}
                        <div>Re-order every {$prod.recurring} days</div>
                      {/if}
                    </div>
                    </div>
                  </div>
