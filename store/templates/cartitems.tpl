...
<form method="post" action="index.php" name="quantities" role="form"> 
 ...
 <div class="cart-wrapper panel panel-default">
  <div class="panel-heading">Product{if $recipient_mapping != ''}s for {$recipient_mapping}{/if}</div>
  <div class="panel-body">
  <div class="row lead hidden-xs">
    <div class="col-sm-1">&nbsp;</div>
    <div class="col-sm-4 col-md-5">Product</div>
    <div class="col-sm-3 col-md-2 text-right">Unit Price</div>
