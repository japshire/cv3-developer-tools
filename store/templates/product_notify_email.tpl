...
{if $type == 'product_notify'} 
  {* product_notify *}
  <a href="http://www.domain.com/product/{if $product.url_name != ''}{$product.url_name}{else}{$product.prod_id}{/if}{$url_split_char}{if $product.cat_url_name != ''}{$product.cat_url_name}{else}{$product.cat_id}{/if}">{$product.prod_name}</a> is now in stock.<br />
<br />
  Thanks!
{/if}
